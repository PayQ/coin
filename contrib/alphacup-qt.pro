...
RESOURCES += src/qt/alphacup.qrc src/qt/alphacup_locale.qrc

TRANSLATIONS += src/qt/locale/alphacup_bg.ts \
                src/qt/locale/alphacup_de.ts \
                src/qt/locale/alphacup_en.ts \
                src/qt/locale/alphacup_es.ts \
                src/qt/locale/alphacup_fi.ts \
                src/qt/locale/alphacup_fr.ts \
                src/qt/locale/alphacup_it.ts \
                src/qt/locale/alphacup_ja.ts \
                src/qt/locale/alphacup_pl.ts \
                src/qt/locale/alphacup_pt.ts \
                src/qt/locale/alphacup_ru.ts \
                src/qt/locale/alphacup_sk.ts \
                src/qt/locale/alphacup_sv.ts \
                src/qt/locale/alphacup_vi.ts \
                src/qt/locale/alphacup_zh_CN.ts \
                src/qt/locale/alphacup_zh_TW.ts
