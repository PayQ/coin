...
In order to support loading of multiple wallets in alphacup-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is alphacup.cpp.
...
Changes to alphacup.cpp
----------------------
alphacup.cpp is the entry point into alphacup-qt, and as such, will require some minor modifications to provide hooks for
