...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AlphaCup Core alphacup-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  alphacup-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alphacup transaction") + "\n" +
                               "  alphacup-tx [options] -create [commands]   " + _("Create hex-encoded alphacup transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded alphacup transaction
