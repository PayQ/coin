...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach (const SendCoinsRecipient& rcp, recipients) {
        ...
        // generate moalphacuppace address string
        QString address = "<span style='font-family: moalphacuppace;'>" + rcp.address;
        address.append("</span>");
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel()) {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid alphacup address"));
        } else // Valid address
        {
            CPubKey pubkey;
            CKeyID keyid;
