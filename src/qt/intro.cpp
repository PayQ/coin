...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AlphaCup Core"),
     ...
     * override -datadir in the alphacup.conf file in the default data directory
     * (to be consistent with alphacupd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
