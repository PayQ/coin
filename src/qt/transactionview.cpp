                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received alphacup from zalcup"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zalcup"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zalcup));
