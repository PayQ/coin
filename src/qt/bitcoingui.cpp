                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AlphaCup Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a alphacup address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alphacup: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zALCUP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AlphaCup Core"), this);
    aboutAction->setStatusTip(tr("Show information about AlphaCup Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for alphacup"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your alphacup addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified alphacup addresses"));
    ...
    multisigSpendAction = new QAction(QIcon(":/icons/export"), tr("&Multisignature spending..."), this);
    ...
    openAction->setStatusTip(tr("Open a alphacup: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/export"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AlphaCup Core help message to get a list with possible alphacup command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AlphaCup Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to alphacup network", "", count));
}
...
{
    QString strTitle = tr("AlphaCup Core"); // default title
...
/** Creates context menu, its actions, and alphacups up all the relevant signals for mouse events. */
