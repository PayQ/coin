...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted alphacup to zalcup");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zalcup");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received alphacup from zalcup");
    case TransactionRecord::ZerocoinSpend_Change_zalcup:
        return tr("Minted Change as zalcup from zalcup Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zalcup to alphacup");
