...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::ALCUP, nValue);
...
{
    std::string genesisblockhash = "0000008738da8b61df9931fda6d652f1d9bc95fe45c4c6643cae2f844f077d0b";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (alphacup.conf).");
            QMessageBox::warning(this, "AlphaCup Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#222; bgcolor:#78aace;}\n a, span { font-family: monospace; }\n span.addr {color:#ddd; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #78aace;}\n td.d0 {font-weight: bold; color:#222;}\n h2, h3 { white-space:nowrap; color:#ddd;}\n a { color:#FFFC00; text-decoration:none; }\n a.nav {color:#ddd;}\n";
