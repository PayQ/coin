...
/** Utility functions used by the alphacup Qt UI.
 */
namespace GUIUtil
{
...
// Render alphacup addresses in moalphacuppace font
...
// Parse "alphacup:" URI into recipient object, return true on successful parsing
