...
public:
    ...
    void setZalcupControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzALCUP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzALCUP_clicked();
    void on_pushButtonZalcupControl_clicked();
