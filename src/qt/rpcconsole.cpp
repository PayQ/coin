...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        ...
        "td.message { font-family: Courier, Courier New, Lucida Console, moalphacuppace; font-size: 12px; } " // Todo: Remove fixed font-size
        "td.cmd-request { color: #006060; } "
        "td.cmd-error { color: red; } "
        "b { color: #006060; } ");

    message(CMD_REPLY, (tr("Welcome to the alphacup RPC console.") + "<br>" +
