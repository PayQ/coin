...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop alphacup server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "alphacup server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* alphacup features */
        {"alphacup", "masternode", &masternode, true, true, false},
        {"alphacup", "listmasternodes", &listmasternodes, true, true, false},
        {"alphacup", "getmasternodecount", &getmasternodecount, true, true, false},
        {"alphacup", "masternodeconnect", &masternodeconnect, true, true, false},
        {"alphacup", "masternodecurrent", &masternodecurrent, true, true, false},
        {"alphacup", "masternodedebug", &masternodedebug, true, true, false},
        {"alphacup", "startmasternode", &startmasternode, true, true, false},
        {"alphacup", "createmasternodekey", &createmasternodekey, true, true, false},
        {"alphacup", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"alphacup", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"alphacup", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"alphacup", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"alphacup", "getmasternodescores", &getmasternodescores, true, true, false},
        {"alphacup", "mnbudget", &mnbudget, true, true, false},
        {"alphacup", "preparebudget", &preparebudget, true, true, false},
        {"alphacup", "submitbudget", &submitbudget, true, true, false},
        {"alphacup", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"alphacup", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"alphacup", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"alphacup", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"alphacup", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"alphacup", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"alphacup", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alphacup", "checkbudgets", &checkbudgets, true, true, false},
        {"alphacup", "mnsync", &mnsync, true, true, false},
        {"alphacup", "spork", &spork, true, true, false},
        {"alphacup", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"alphacup", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use alphacupd, or the -server option to alphacup-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> alphacup-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13110/\n";
}
