...
{
public:
    /// Is the inputs associated with this public key? (and there is 2500 ALCUP - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of alphacup.
