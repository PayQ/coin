/* src/config/alphacup-config.h.  Generated from alphacup-config.h.in by configure.  */
/* src/config/alphacup-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ALCUP_CONFIG_H

#define ALCUP_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.alphacup.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AlphaCup Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AlphaCup Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "alphacup"
