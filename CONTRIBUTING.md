Contributing to AlphaCup Core
============================

The AlphaCup Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AlphaCup Core project, and is not to be
confused with overall alphacup Network Protocol consensus changes.

Whether a pull request is merged into AlphaCup Core rests with the project merge
...
Patches that change alphacup consensus rules are considerably more involved than
...
Where a patch set proposes to change the alphacup consensus, it must have been
...
The project leader is the release manager for each AlphaCup Core release.
